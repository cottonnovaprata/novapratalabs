...
export default function NetworkPage() {
  ...
  async function handleSaveSegment(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Não foi possível salvar a VLAN")
      }
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Dados de conectividade e segmentação alimentados pelo banco.</p>
        </div>
        ...
        <Card className="bg-sky-500/5 border-sky-500/20">
          <CardContent className="p-4 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-2xl font-bold text-sky-600">{ipsProtectionActive ? "ACTIVE" : "ATENÇÃO"}</p>
            </div>
                      ...
                      <div className="flex items-center gap-2 w-40">
                        <div className="flex-1 h-2 bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{ width: `${Math.max(segment.usagePercent, 2)}%` }}
                          />
                        </div>
        ...
        <form className="space-y-4" onSubmit={handleSaveSegment}>
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="VLAN 60 - Laboratório"
              required
            />
          </div>
